...
ARTIFACT_KINDS: dict[str, set[str]] = {
    ...
    "destination-audit": {"project", "leaves", "findings"},
    "destination-spec": {"destination", "leaves"},
    "destination-check": {"findings", "summary"},
    "feature-integration-audit": {"feature", "feature_modules", "app_modules", "evidence", "findings"},
    "feature-integration-plan": {"feature", "feature_modules", "app_modules", "actions"},
    "di-boundary-audit": {"frameworks", "declarations", "modules", "findings"},
    "di-migration-plan": {"target_framework", "graph_modules", "actions", "preserved_contracts"},
    "feature-coupling-report": {"edges", "findings"},
    "feature-decoupling-plan": {"batches", "preserved_contracts"},
    "data-boundary-audit": {"components", "wire_contracts", "findings"},
    "data-boundary-plan": {"assignments", "delegated", "wire_contracts", "preserved_contracts"},
    "test-boundary-audit": {"test_sources", "production_matches", "project_edges", "findings"},
    "test-migration-plan": {"moves", "support_candidates", "production_test_edges"},
    "resource-audit": {"definitions", "usages", "cross_module_usages", "findings"},
    "resource-migration-plan": {"moves", "preserved_contracts"},
    "persistence-boundary-audit": {"components", "database_versions", "stored_identities", "schema_files", "findings"},
    "persistence-migration-plan": {"assignments", "database_versions", "stored_identities", "schema_files"},
    "module-consolidation-audit": {"source_modules", "target_module", "graph_before", "graph_after", "inventories", "findings"},
    "module-consolidation-plan": {"source_modules", "target_module", "actions", "expected_graph"},
    "module-consolidation-check": {"target_module", "retired_modules", "findings"},
    "generic": set(),
}
